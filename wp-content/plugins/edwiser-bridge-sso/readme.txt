...
== Changelog ==
= 1.4.4 =
* Feature - added icon image upload/show for login with wordpress in moodle
* Tweak - added compatibility for wordpress 6.0
* Fix - auto plugin enable in moodle

= 1.4.3 =
* Tweak - Added compatibility with Moodle 4.0.

= 1.4.2 =
* Fixed: changed setting name for Google Oauth2
* Fixed: php notice on moodle login page

= 1.4.1 =
* Feature - Replaced Google plus with Google Oauth2.
* Feature - Added Login with WordPress functionality on Moodle.
* Feature - Added support to WordPress 5.1.9 and Twenty Twenty two theme.
* Tweak - Replaced Google plus icon with Google icon.
* Fix - Fixed eb_sso_social_login shortcode output issue.


= 1.4.0 =
* Fix - Fixed WordPress site health session issue.

= 1.3.9 =
* Fix - Fixed Moodle login issue for non linked users.
