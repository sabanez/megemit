...
if (!class_exists('SSOSettingsRedirection')) {
    ...
    class SSOSettingsRedirection
    {
        ...
        {
            $heders = array( __( 'User Roles', 'single_sign_on_text_domain'), __( 'Redirect', 'single_sign_on_text_domain' ), __( 'Manage', 'single_sign_on_text_domain' ) );
        ...
        private function createRoleRediRule($addRulesForRole, $pos)
        {
            ...
            <div class="ebsso-setting-red-rule">
                ...
                <input type="button" id="<?php echo $btnId; ?>" name="<?php echo $btnId; ?>" class="ebsso-add-new-redirect-rule" value="<?php echo _e('Add', 'single_sign_on_text_domain'); ?>">
