        ...
        public function getSocialLoginSettings()
        {
            ...
            $settings = apply_filters(
                ...
                array(
                    ...
                    array(
                        'title'    => __('Google OAuth login ', 'single_sign_on_text_domain'),
                        'desc'     => '<br/>' .
                            __(
                        ...
                        'id'       => 'eb_sso_gp_enable',
                        'type'     => 'select',
                        'default'  => __('Select Page', 'single_sign_on_text_domain'),
                        'css'      => 'min-width:300px;',
                        'options'     => array(
                    ...
                    array(
                        ...
                        'desc'     => __('Enter your google OAuth client id here.', "single_sign_on_text_domain"),
                    ...
                    array(
                        ...
                        'desc'              => __('Enter your google OAuth app secret key here.', "single_sign_on_text_domain"),
                    ...
                    /*array(
                        ...
                        'desc'              => __('Enter your google OAuth app name here.', "single_sign_on_text_domain"),
