...
== Changelog ==
= 2.1.3 =
* Tweak: optimized course synchronization process.
* Fixed: category fetching issue for more than 2 levels of the category.

= 2.1.2 =
* Fix: Fixed plugin updater warning.
