                ...
                <main class="modal__content">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <input type="text" class="wpsl-exit-survey-suggestions" placeholder="<?php esc_html_e( 'Please tell us which plugin?', 'wp-store-locator' ) ?>">
                        </li>
                        <li>
                            ...
                            <input type="text" class="wpsl-exit-survey-suggestions" placeholder="<?php esc_html_e( 'Please tell us which feature you\'re missing?', 'wp-store-locator' ) ?>">
                        </li>
                        <li>
                            <input id="wpsl-temporary-deactivation" type="radio" name="survey-reason" value="temporary_deactivation">
                            <label for="wpsl-temporary-deactivation"><?php esc_html_e( 'It\'s a temporary deactivation' ,'wp-store-locator' ); ?>
                        </li>
                        <li>
                            ...
                            <input type="text" class="wpsl-exit-survey-suggestions" placeholder="<?php esc_html_e( 'What can we improve?', 'wp-store-locator' ) ?>">
                        </li>
                    </ul>
                </main>
