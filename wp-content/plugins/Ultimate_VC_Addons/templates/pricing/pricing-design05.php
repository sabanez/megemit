...
if ( ! function_exists( 'ult_price_generate_design05' ) ) {
	...
	function ult_price_generate_design05( $atts, $content = null ) {
		...
		// Heading tag.
		if ( ! in_array( $ult_pricing_design05['heading_tag'], $valid_tags ) ) {
			$ult_pricing_design05['heading_tag'] = 'h3';
		}

		// Sub Heading tag.
		if ( ! in_array( $ult_pricing_design05['sub_heading_tag'], $valid_tags ) ) {
			$ult_pricing_design05['sub_heading_tag'] = 'h5';
		}
		...
		if ( '' !== $ult_pricing_design05['package_sub_heading'] ) {
			$output .= '<' . esc_attr( $ult_pricing_design05['sub_heading_tag'] ) . ' ' . $price_table_subhead_data_list . ' class="price-subheading ult-responsive cust-subhead" style="' . esc_attr( $sub_heading_inline ) . '">' . esc_html( $ult_pricing_design05['package_sub_heading'] ) . '</' . esc_attr( $ult_pricing_design05['sub_heading_tag'] ) . '>';
		}
