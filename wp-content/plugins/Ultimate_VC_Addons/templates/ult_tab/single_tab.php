...
$output   .= "\n\t\t\t" . '</div> ';
echo $output;  //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Sanitizing this output breaks the plugin's expected HTML structure for external feeds plugins.
