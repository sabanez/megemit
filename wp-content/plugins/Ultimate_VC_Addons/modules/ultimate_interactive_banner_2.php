...
if ( ! class_exists( 'Ultimate_VC_Addons_Interactive_Banner' ) ) {
	...
	class Ultimate_VC_Addons_Interactive_Banner {
		...
		public function banner_shortcode( array $atts ) {
			...
			if ( ! in_array( $ult_interactive_banner_2_settings['heading_tag'], $valid_tags ) ) {
				$ult_interactive_banner_2_settings['heading_tag'] = 'h2';
			}
			...
			$output .= '<div tabindex="0" class="ult-new-ib ult-ib-effect-' . esc_attr( $ult_interactive_banner_2_settings['banner_style'] ) . ' ' . esc_attr( $ult_interactive_banner_2_settings['el_class'] ) . ' ' . esc_attr( $min_height_class ) . ' ' . esc_attr( $css_ib2_styles ) . '" ' . $responsive . ' style="' . esc_attr( $banner_style_inline ) . '" data-opacity="' . esc_attr( $ult_interactive_banner_2_settings['image_opacity'] ) . '" data-hover-opacity="' . esc_attr( $ult_interactive_banner_2_settings['image_opacity_on_hover'] ) . '" ' . $banner_min_height . '>';
			if ( '' !== $img ) {
