	...
	class Ultimate_VC_Addons_Icon_Timeline {
		...
		public function icon_timeline( $atts, $content = null ) {
			...
			if ( '' != $ult_icon_timeline_settings['timeline_line_style'] ) {
				$ult_icon_timeline_settings['line_style'] .= 'border-right-color:' . esc_attr( $ult_icon_timeline_settings['timeline_line_color'] ) . ';';
			}
			if ( 'jstime' == $ult_icon_timeline_settings['timeline_style'] ) {
				...
				$output .= '<div class="smile-icon-timeline-wrap ' . esc_attr( $ult_icon_timeline_settings['timeline_style'] ) . ' ' . esc_attr( $ult_icon_timeline_settings['el_class'] ) . ' ' . esc_attr( $ult_icon_timeline_settings['timeline_layout'] ) . ' ' . esc_attr( $ult_icon_timeline_settings['tl_animation'] ) . '" ' . $cw . ' ' . esc_attr( $ult_icon_timeline_settings['time_sep_bg_color'] ) . ' ' . esc_attr( $ult_icon_timeline_settings['time_block_bg_color'] ) . ' ' . esc_attr( $ult_icon_timeline_settings['time_sep_color'] ) . ' style="opacity:0; ' . esc_attr( $timeline_design_css ) . '">';
			} else {
				$output .= '<div class="smile-icon-timeline-wrap ' . esc_attr( $ult_icon_timeline_settings['timeline_style'] ) . ' ' . esc_attr( $ult_icon_timeline_settings['el_class'] ) . ' ' . esc_attr( $ult_icon_timeline_settings['timeline_layout'] ) . ' ' . esc_attr( $ult_icon_timeline_settings['tl_animation'] ) . '" ' . $cw . ' ' . esc_attr( $ult_icon_timeline_settings['time_sep_bg_color'] ) . ' ' . esc_attr( $ult_icon_timeline_settings['time_block_bg_color'] ) . ' ' . esc_attr( $ult_icon_timeline_settings['time_sep_color'] ) . ' style="' . esc_attr( $timeline_design_css ) . '">';
			}
		...
		public function icon_timeline_sep( $atts, $content = null ) {
			...
			if ( '' != $ult_timeline_sep_settings['time_sep_color'] ) {
				$seperator_style .= 'color:' . esc_attr( $ult_timeline_sep_settings['time_sep_color'] ) . ';';
			}
			if ( '' != $ult_timeline_sep_settings['line_style'] ) {
				$seperator_style .= 'border-style:' . esc_attr( $ult_timeline_sep_settings['line_style'] ) . ';';
			}
			if ( '' != $ult_timeline_sep_settings['line_color'] ) {
				$seperator_style .= 'border-color:' . esc_attr( $ult_timeline_sep_settings['line_color'] ) . ';';
			}
		...
		public function icon_timeline_feat( $atts, $content = null ) {
			...
			if ( ! in_array( $ult_timeline_feat_settings['heading_tag'], $valid_tags ) ) {
				$ult_timeline_feat_settings['heading_tag'] = 'h3';
			}
			...
			if ( '' != $ult_timeline_feat_settings['line_color'] ) {
				$ult_timeline_feat_settings['line_style'] = 'border-right-color:' . esc_attr( $ult_timeline_feat_settings['line_color'] ) . ';';
			}
			...
			if ( '' != $ult_timeline_feat_settings['title_font_color'] ) {
				$title_style .= 'color:' . esc_attr( $ult_timeline_feat_settings['title_font_color'] ) . ';';
			}
			/* description */
			...
			if ( '' != $ult_timeline_feat_settings['desc_font_color'] ) {
				$desc_style .= 'color:' . esc_attr( $ult_timeline_feat_settings['desc_font_color'] ) . ';';
			}
			...
			$li_suffix                          = '</div>';
			$style                              = ( '' !== $time_icon_color ) ? ' color:' . esc_attr( $time_icon_color ) . ';' : ' ';
			$style                             .= ( '' !== $time_icon_bg_color ) ? ' background:' . esc_attr( $time_icon_bg_color ) . ';' : ' ';
			...
			$header .= '<' . esc_attr( sanitize_key( $ult_timeline_feat_settings['heading_tag'] ) ) . '
			 class="ult-timeline-title ult-responsive"  ' . $data_list . ' style="' . esc_attr( $title_style ) . '">' . wp_kses_post( $ult_timeline_feat_settings['time_title'] ) . '</' . esc_attr( sanitize_key( $ult_timeline_feat_settings['heading_tag'] ) ) . '>';
		...
		public function icon_timeline_item( $atts, $content = null ) {
			...
			if ( '' != $ult_timeline_item_settings['line_color'] ) {
				$ult_timeline_feat_settings['line_style'] = 'border-right-color:' . esc_attr( $ult_timeline_item_settings['line_color'] ) . ';';
			}
			...
			if ( '' != $ult_timeline_item_settings['title_font_color'] ) {
				$title_style .= 'color:' . esc_attr( $ult_timeline_item_settings['title_font_color'] ) . ';';
			}
			/* description */
			...
			if ( '' != $ult_timeline_item_settings['desc_font_color'] ) {
				$desc_style .= 'color:' . esc_attr( $ult_timeline_item_settings['desc_font_color'] ) . ';';
			}
