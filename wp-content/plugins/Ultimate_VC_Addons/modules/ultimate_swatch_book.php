	...
	class Ultimate_VC_Addons_Swatch_Book {
		...
		public function swatch_container( $atts, $content = null ) {
			...
			if ( '' !== $ult_swatch_settings['swatch_width'] ) {
				$style             .= 'width:' . esc_attr( $ult_swatch_settings['swatch_width'] ) . 'px;';
			...
			if ( '' !== $ult_swatch_settings['swatch_main_strip_highlight_font_size'] ) {
				$highlight_style .= 'font-size:' . esc_attr( $ult_swatch_settings['swatch_main_strip_highlight_font_size'] ) . 'px;';
			}
			if ( '' !== $ult_swatch_settings['swatch_main_strip_highlight_font_weight'] ) {
				$highlight_style .= 'font-weight:' . esc_attr( $ult_swatch_settings['swatch_main_strip_highlight_font_weight'] ) . ';';
			}
			if ( '' !== $ult_swatch_settings['swatch_main_strip_highlight_color'] ) {
				$highlight_style .= 'color:' . esc_attr( $ult_swatch_settings['swatch_main_strip_highlight_color'] ) . ';';
			}
			...
			if ( '' !== $ult_swatch_settings['swatch_main_strip_font_size'] ) {
				$main_style .= 'font-size:' . esc_attr( $ult_swatch_settings['swatch_main_strip_font_size'] ) . 'px;';
			}
			if ( '' !== $ult_swatch_settings['swatch_main_strip_font_style'] ) {
				$main_style .= 'font-weight:' . esc_attr( $ult_swatch_settings['swatch_main_strip_font_style'] ) . ';';
			}
			if ( '' !== $ult_swatch_settings['swatch_main_strip_color'] ) {
				$main_style .= 'color:' . esc_attr( $ult_swatch_settings['swatch_main_strip_color'] ) . ';';
			}
			if ( '' !== $ult_swatch_settings['swatch_main_strip_bg_color'] ) {
				$main_style .= 'background:' . esc_attr( $ult_swatch_settings['swatch_main_strip_bg_color'] ) . ';';
			}
			...
			$output .= '<h4 class="strip_main_text" style="' . esc_attr( $main_style ) . '"><span>' . wp_kses_post( $ult_swatch_settings['swatch_main_strip_text'] ) . '</span></h4>';
			$output .= '<h5 class="strip_highlight_text" style="' . esc_attr( $highlight_style ) . '"><span>' . wp_kses_post( $ult_swatch_settings['swatch_main_strip_highlight_text'] ) . '</span></h5>';
			$output .= '</div>';
			$output .= '</div>';
