...
if ( ! class_exists( 'Ultimate_VC_Addons_Info_Table' ) ) {
	...
	class Ultimate_VC_Addons_Info_Table {
		 ...
		 */
		public function ultimate_it_init() {
					...
					array(
						...
						'params'      => array(
							...
							array(
								...
								'value'            => array(
									esc_html__( 'Default', 'ultimate_vc' ) => 'h5',
									esc_html__( 'H1', 'ultimate_vc' )  => 'h1',
									esc_html__( 'H2', 'ultimate_vc' )  => 'h2',
		...
		/**
		 *  Ultimate IP Shortcode.
		 *
		 * @method ultimate_it_shortcode
		 * @param array  $atts Attributes.
		 * @param string $content Content.
		 */
		public function ultimate_it_shortcode( array $atts, $content = null ) {
			$design_style = '';

				$ult_infotbl_settings = shortcode_atts(
					array(
