			...
			if ( function_exists( 'vc_add_param' ) ) {
				...
				vc_add_param(
					...
					array(
						...
						'description' => __( 'Options to control repeatation of the background image.', 'ultimate_vc' ) . ' ' . __( 'Learn on', 'ultimate_vc' ) . " <a href='https://www.w3schools.com/cssref/playdemo.php?filename=playcss_background-repeat' target='_blank' rel='noopener'>" . __( 'W3School', 'ultimate_vc' ) . '</a>',
						'dependency'  => array(
							'element' => 'parallax_style',
