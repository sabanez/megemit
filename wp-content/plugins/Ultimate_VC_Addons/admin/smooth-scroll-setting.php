...
<div class="wrap-container">
	...
	<div class="smile-settings-wrapper">
			<h2 class="nav-tab-wrapper">
				...
				<a href="<?php echo admin_url( 'admin.php?page=ultimate-smoothscroll' . $author_extend ); // PHPCS:ignore:WordPress.Security.EscapeOutput.OutputNotEscaped ?>" data-tab="css-settings" class="nav-tab nav-tab-active"> <?php echo esc_html__( 'Smooth Scroll', 'ultimate_vc' ); ?> </a>
		...
		<div class="col-md-12">
			...
			<form method="post" id="ultimate_settings">
				...
				<table class="form-table">
					<tbody>
						<tr valign="top">
							<th scope="row"><?php echo esc_html__( 'Smooth Scroll', 'ultimate_vc' ); ?></th>
							<td>
