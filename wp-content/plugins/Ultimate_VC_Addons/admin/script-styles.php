...
<div class="wrap-container">
	...
	<div class="smile-settings-wrapper">
			<h2 class="nav-tab-wrapper">
				...
				<a href="<?php echo admin_url( 'admin.php?page=ultimate-scripts-and-styles' . $author_extend ); // PHPCS:ignore:WordPress.Security.EscapeOutput.OutputNotEscaped ?>" data-tab="css-settings" class="nav-tab nav-tab-active"> <?php echo esc_html__( 'Scripts and Styles', 'ultimate_vc' ); ?> </a>
				<?php if ( $author ) : ?>
			...
			<div id="css-settings" class="ult-tabs active-tab">
				<form method="post" id="css_settings">
					...
					<table class="form-table">
						<tbody>
							<tr valign="top">
								<th scope="row"><?php echo esc_html__( 'Combined CSS', 'ultimate_vc' ); ?></th>
							...
							<tr valign="top">
								<th scope="row"><?php echo esc_html__( 'Combined JS', 'ultimate_vc' ); ?></th>
								<td> <div class="onoffswitch">
