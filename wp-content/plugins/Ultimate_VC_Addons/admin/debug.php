			...
			<div class="col-md-12">
				<?php if ( $author ) : ?>
					<div id="ultimate-debug" class="ult-tabs active-tab">
							...
							<table class="form-table">
								<tbody>
									...
									<tr valign="top">
										...
										<td>
											<a href="<?php echo esc_url( wp_nonce_url( admin_url( 'admin.php?page=bsf-font-icon-manager&delete-bsf-fonts' ), 'delete-bsf-fonts' ) ); ?>" target="_blank" class="button">Reset Icon Fonts</a>
										</td>
									</tr>
									<?php
									...
									<!--<tr valign="top">
										...
										<td>
											<div>
												<a href="<?php echo esc_url( wp_nonce_url( admin_url( 'admin.php?page=bsf-dashboard&deregister-licence' ), 'deregister-licence' ) ); ?>" target="_blank" class="button-primary">Deregister Licence</a>
											</div>
										</td>
									</tr>-->
									<?php
									...
									<tr valign="top">
										...
										<td>
											...
											foreach ( $roles as $role_name => $role_info ) :
												...
												?>
													<div>
														<input <?php echo ( $is_admin ) ? 'disabled' : ''; ?> id="<?php echo esc_attr( $role_name ); ?>" type="checkbox" name="bsf_options[ultimate_roles][]" value="<?php echo esc_attr( $role_name ); ?>" <?php echo esc_attr( $checked ); ?> /><label for="<?php echo esc_attr( $role_name ); ?>"><?php echo esc_html( $role_info['name'] ); ?></label>
													</div>
												<?php
												endforeach;
											?>
						...
						<p class="submit"><input type="submit" name="submit" id="submit-debug-settings" class="button button-primary" value="<?php echo esc_attr__( 'Save Changes', 'ultimate' ); ?>"></p>
					</div>
				<?php endif; ?>
		</div> <!--col-md-12 -->
