...
class Migration_3_3_9
{
    ...
    public function run()
    {
        ...
        foreach ($configuredLanguages as $languageCode) {
            ...
            $localization->iabTcfDescriptionLegInt = str_replace(' aria-expanded="false"', '', $localization->iabTcfDescriptionLegInt);
            $localization->iabTcfDescriptionMoreInformation = str_replace(' aria-expanded="false"', '', $localization->iabTcfDescriptionMoreInformation);
            $localization->iabTcfDescriptionRevoke = str_replace('', ' aria-expanded="false"', $localization->iabTcfDescriptionRevoke);
            $localization->legalInformationDescriptionRevoke = str_replace(' aria-expanded="false"', '', $localization->legalInformationDescriptionRevoke);
            $dialogLocalizationSaveStatus = $dialogLocalization->save($localization, $languageCode);
