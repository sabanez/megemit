...
use Borlabs\Cookie\System\ThirdPartyImporter\ThirdPartyImportManager;

class Migration_3_2_0
{
    ...
    public function run()
    {
        ...
        $thirdPartyImportManager = $this->container->get(ThirdPartyImportManager::class);
        $thirdPartyImportManager->import();
