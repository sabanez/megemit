...
class Migration_3_1_0
{
    ...
    public function run()
    {
        ...
        $pluginConfigDto->packageAutoUpdateEmailAddresses = [
            $option->getThirdPartyOption('admin_email', '')->value,
        ];
        $pluginConfigDto->packageAutoUpdateInterval = AutoUpdateIntervalEnum::AFTER_24_HOURS();
        $pluginConfigDto->packageAutoUpdateTime = '08:30';
