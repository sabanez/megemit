	...
	<ul>
		...
		foreach ( $eb_pages as $eb_page ) {
			if ( $current_page === $eb_page ) {
				echo '<li><span class=" page-numbers eb-page-numbers current" data-page="' . esc_attr( $eb_page ) . '">' . esc_html( $eb_page ) . '</span></li>';
			} else {
				echo '<li><a class="page-numbers eb-page-numbers" href="' . esc_url( get_pagenum_link( $eb_page ) ) . '" data-page="' . esc_attr( $eb_page ) . '">' . esc_html( $eb_page ) . '</a></li>';
			}
			$prev_page = $eb_page;
		}
		?>
