...
export const ICONS = [
  {
    ...
    name: 'Layout',
    icon: Icons.layout,
    meta: ['dashboard', 'admin', 'panel'],
  },
  {
    id: 'home',
    name: 'Home',
    icon: Icons.home,
    meta: ['home', 'main', 'landing'],
  },
  {
    id: 'search',
    name: 'Search',
    icon: Icons.search,
    meta: ['search', 'find', 'lookup'],
  },
  {
    id: 'filter',
    name: 'Filter',
    icon: Icons.filter,
    meta: ['filter', 'sort', 'options'],
  },
  {
    id: 'clock',
    name: 'Clock',
    icon: Icons.clock,
    meta: ['time', 'duration', 'deadline'],
  },
  {
    id: 'user',
    name: 'User',
    icon: Icons.user,
    meta: ['user', 'account', 'profile'],
  },
  {
    id: 'users',
    name: 'Users',
    icon: Icons.users,
    meta: ['users', 'students', 'instructors', 'community'],
  },
  {
    id: 'settings',
    name: 'Settings',
    icon: Icons.settings,
    meta: ['settings', 'account', 'preferences'],
  },
  {
    id: 'shield-check',
    name: 'Shield Check',
    icon: Icons.shieldCheck,
    meta: ['security', 'verified', 'safe'],
  },
  {
    id: 'log-in',
    name: 'Log In',
    icon: Icons.login,
    meta: ['login', 'sign in', 'auth'],
  },
  {
    id: 'log-out',
    name: 'Log Out',
    icon: Icons.logout,
    meta: ['logout', 'sign out', 'exit'],
  },
  {
    id: 'award',
    name: 'Award',
    icon: Icons.award,
    meta: ['award', 'certificate', 'badge'],
  },
  {
    id: 'shopping-cart',
    name: 'Shopping Cart',
    icon: Icons.shoppingCart,
    meta: ['cart', 'checkout', 'shopping'],
  },
  {
    id: 'shopping-bag',
    name: 'Shopping Bag',
    icon: Icons.shoppingBag,
    meta: ['bag', 'shopping', 'store'],
  },
  {
    id: 'package',
    name: 'Package',
    icon: Icons.package,
    meta: ['orders', 'package', 'delivery'],
  },
  {
    id: 'repeat',
    name: 'Repeat',
    icon: Icons.repeat,
    meta: ['subscriptions', 'renew', 'recurring'],
  },
  {
    id: 'credit-card',
    name: 'Credit Card',
    icon: Icons.creditCard,
    meta: ['payment', 'credit card', 'billing'],
  },
  {
    id: 'receipt',
    name: 'Receipt',
    icon: Icons.receipt,
    meta: ['receipt', 'invoice', 'bill', 'payment'],
  },
  {
    id: 'tag',
    name: 'Tag',
    icon: Icons.tag,
    meta: ['tag', 'discount', 'offer'],
  },
  {
    id: 'gift',
    name: 'Gift',
    icon: Icons.gift,
    meta: ['gift', 'voucher', 'present'],
  },
  {
    id: 'store',
    name: 'Store',
    icon: Icons.store,
    meta: ['store', 'shop', 'commerce'],
  },
  {
    id: 'dollar-sign',
    name: 'Dollar Sign',
    icon: Icons.dollarSign,
    meta: ['dollar', 'money', 'payment', 'price'],
  },
  {
    id: 'graduation-cap',
    name: 'Graduation Cap',
    icon: Icons.graduationCap,
    meta: ['education', 'course', 'graduation'],
  },
  {
    id: 'book-open',
    name: 'Book Open',
    icon: Icons.bookOpen,
    meta: ['book', 'reading', 'courses'],
  },
  {
    id: 'notebook',
    name: 'Notebook',
    icon: Icons.notebook,
    meta: ['notebook', 'notes', 'study'],
  },
  {
    id: 'presentation',
    name: 'Presentation',
    icon: Icons.presentation,
    meta: ['presentation', 'lecture', 'slides'],
  },
  {
    id: 'library',
    name: 'Library',
    icon: Icons.library,
    meta: ['library', 'resources', 'books'],
  },
  {
    id: 'school',
    name: 'School',
    icon: Icons.school,
    meta: ['school', 'class', 'education'],
  },
  {
    id: 'question',
    name: 'Question',
    icon: Icons.question,
    meta: ['question', 'quiz', 'module', 'help'],
  },
  {
    id: 'layers',
    name: 'Layers',
    icon: Icons.layers,
    meta: ['layers', 'modules', 'sections'],
  },
  {
    id: 'brain',
    name: 'Brain',
    icon: Icons.brain,
    meta: ['brain', 'learning', 'thinking'],
  },
  {
    id: 'bookmark',
    name: 'Bookmark',
    icon: Icons.bookmark,
    meta: ['bookmark', 'save', 'favorite'],
  },
  {
    id: 'text-file',
    name: 'Text File',
    icon: Icons.fileText,
    meta: ['file', 'document', 'resources', 'text'],
  },
  {
    id: 'check-list',
    name: 'Check List',
    icon: Icons.listChecks,
    meta: ['tasks', 'assignments', 'checklist'],
  },
  {
    id: 'puzzle',
    name: 'Puzzle',
    icon: Icons.puzzle,
    meta: ['puzzle', 'quiz', 'module'],
  },
  {
    id: 'folder',
    name: 'Folder',
    icon: Icons.folder,
    meta: ['folder', 'directory', 'files'],
  },
  {
    id: 'database',
    name: 'Database',
    icon: Icons.database,
    meta: ['database', 'data', 'storage'],
  },
  {
    id: 'ticket',
    name: 'Ticket',
    icon: Icons.ticket,
    meta: ['ticket', 'support', 'help'],
  },
  {
    id: 'pen',
    name: 'Pen',
    icon: Icons.pen,
    meta: ['pen', 'pencil', 'writing'],
  },
  {
    id: 'ruler',
    name: 'Ruler',
    icon: Icons.ruler,
    meta: ['ruler', 'measure', 'length'],
  },
  {
    id: 'message-circle',
    name: 'Message Circle',
    icon: Icons.messageCircle,
    meta: ['message', 'chat', 'conversation'],
  },
  {
    id: 'message-square',
    name: 'Message Square',
    icon: Icons.messageSquare,
    meta: ['chat', 'discussion', 'forum'],
  },
  {
    id: 'calendar',
    name: 'Calendar',
    icon: Icons.calendar,
    meta: ['calendar', 'schedule', 'events', 'date'],
  },
  {
    id: 'bell',
    name: 'Bell',
    icon: Icons.bell,
    meta: ['notifications', 'alerts', 'reminder'],
  },
  {
    id: 'star',
    name: 'Star',
    icon: Icons.star,
    meta: ['star', 'reviews', 'rating'],
  },
  {
    id: 'globe',
    name: 'Globe',
    icon: Icons.globe,
    meta: ['globe', 'world', 'language'],
  },
  {
    id: 'mic',
    name: 'Mic',
    icon: Icons.mic,
    meta: ['microphone', 'webinar', 'voice'],
  },
  {
    id: 'headphones',
    name: 'Headphones',
    icon: Icons.headphones,
    meta: ['audio', 'podcast', 'listening'],
  },
  {
    id: 'monitor-smartphone',
    name: 'Monitor Smartphone',
    icon: Icons.monitorSmartphone,
    meta: ['online', 'virtual', 'screen', 'device'],
  },
  {
    id: 'play',
    name: 'Play',
    icon: Icons.playCircle,
    meta: ['video', 'play', 'lecture'],
  },
  {
    id: 'line-chart',
    name: 'Line Chart',
    icon: Icons.chartLine,
    meta: ['analytics', 'progress', 'performance'],
  },
  {
    id: 'pie-chart',
    name: 'Pie Chart',
    icon: Icons.chartPie,
    meta: ['stats', 'reports', 'analytics'],
  },
  {
    id: 'check',
    name: 'Check',
    icon: Icons.checkCircle,
    meta: ['completed', 'done', 'success'],
  },
  {
    id: 'bar-chart',
    name: 'Bar Chart',
    icon: Icons.barChart,
    meta: ['chart', 'graph', 'progress'],
  },
  {
    id: 'list',
    name: 'List',
    icon: Icons.list,
    meta: ['list', 'overview', 'items'],
  },
  {
    id: 'target',
    name: 'Target',
    icon: Icons.target,
    meta: ['goal', 'objective', 'target'],
  },
  {
    id: 'download',
    name: 'Download',
    icon: Icons.download,
    meta: ['download', 'save', 'export'],
  },
  {
    id: 'upload',
    name: 'Upload',
