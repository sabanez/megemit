...
function Dashboard({ pageTitle, hidePageTitle }) {
  ...
  return (
    <MantineProvider>
      <div className="eb-user-account__dashboard">
        {!hidePageTitle && <h3 className="eb-dashboard__title">{pageTitle}</h3>}
...
export const DashboardSkeleton = ({ pageTitle, hidePageTitle }) => {
  return (
    <div className="eb-user-account__dashboard">
      {!hidePageTitle && <h3 className="eb-dashboard__title">{pageTitle}</h3>}
      <div className="eb-dashboard__profle">
