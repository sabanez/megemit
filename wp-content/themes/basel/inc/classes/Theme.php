...
class BASEL_Theme {
	...
	public function __construct() {
		...
		$this->files_include = array(
			...
			'woocommerce/free-gifts/class-main',
			...
			'options/controls/conditions/class-conditions',
		...
		add_action( 'init', array( $this, 'theme_options' ), 5 );
	}
	...
	public function theme_options() {
		foreach ( $this->theme_options as $file ) {
			$path = apply_filters( 'basel_require', BASEL_FRAMEWORK . '/' . $file . '.php' );
			if ( file_exists( $path ) ) {
				require_once $path;
			}
