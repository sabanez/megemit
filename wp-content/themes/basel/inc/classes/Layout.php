...
class BASEL_Layout {
	...
	private function _set_sidebar_name() {
		...
		if( basel_woocommerce_installed() && ( is_product_taxonomy() || is_shop() || is_tax( 'product_brand' ) || is_product_category() || is_product_tag() || basel_is_product_attribute_archieve() ) ) {
	...
	private function _set_sidebar_col_width() {
		...
		if( basel_woocommerce_installed() && ( is_shop() || is_product_category() || is_tax( 'product_brand' ) || is_product_tag() || basel_is_product_attribute_archieve() ) ) {
	...
	private function _set_page_layout() {
		...
		if( basel_woocommerce_installed() && ( is_shop() || is_product_category() || is_product_tag() || is_tax( 'product_brand' ) || basel_is_product_attribute_archieve() ) ) {
