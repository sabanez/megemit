...
if ( ! function_exists( 'basel_register_post_category_metaboxes' ) ) {
	/**
	 * Register post category metaboxes.
	 *
	 * @return void
	 */
	function basel_register_post_category_metaboxes() {
	...
	add_action( 'init', 'basel_register_post_category_metaboxes', 30 );
}
