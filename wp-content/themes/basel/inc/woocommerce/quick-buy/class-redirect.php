...
class Redirect extends Singleton {
	...
	public function add_to_cart_action() {
		if ( ! isset( $_REQUEST['basel-add-to-cart'] ) || ! is_numeric( wp_unslash( $_REQUEST['basel-add-to-cart'] ) ) ) { //phpcs:ignore
			return;
		}
		...
		if ( ! isset( $_REQUEST['add-to-cart'] ) || $_REQUEST['add-to-cart'] !== $_REQUEST['basel-add-to-cart'] ) { //phpcs:ignore
			$_REQUEST['add-to-cart'] = $_REQUEST['basel-add-to-cart']; //phpcs:ignore
		}
	...
	public function quick_buy_redirect( $url ) {
		if ( ! isset( $_REQUEST['basel-add-to-cart'] ) ) { //phpcs:ignore
			return $url;
		}
	...
	public function get_redirect_url() {
		$url      = array( 'url' => '' );
		$redirect = basel_get_opt( 'buy_now_redirect', 'checkout' );
