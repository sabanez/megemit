...
class Bundles_Table extends \WP_List_Table {
	...
	public function __construct( $product_id = '' ) {
		parent::__construct(
			array(
				'singular' => __( 'types', 'basel' ),
				'plural'   => __( 'type', 'basel' ),
				'ajax'     => true,
			)
		);
	...
	public function get_columns() {
		$data['name']     = esc_html__( 'Bundles name', 'basel' );
		$data['products'] = esc_html__( 'Products', 'basel' );
	...
	public function prepare_items( $product_id = '' ) {
		...
		$bundles_id = get_post_meta( $product_id, '_basel_fbt_bundles_id', true );
	...
	public function no_items() {
		esc_html_e( 'No bundles found.', 'basel' );
	}
}
