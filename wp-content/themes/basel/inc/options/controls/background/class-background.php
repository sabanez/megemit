		...
		?>
			<div class="xts-bg-source">
				...
				<div class="xts-upload-btns">
					<a class="xts-btn xts-upload-btn"><?php esc_html_e( 'Upload', 'xts-theme' ); ?></a>
					<a class="xts-btn xts-remove-upload-btn<?php echo ( isset( $value['url'] ) && ! empty( $value['url'] ) ) ? ' xts-btn-shown' : ''; ?>"><?php esc_html_e( 'Remove', 'xts-theme' ); ?></a>
