...
<div class="quantity<?php echo 'hidden' === $type ? ' hidden' : ''; ?>">
	...
	<?php if ( 'number' === $type ) : ?>
		<input type="button" value="-" class="minus" aria-label="<?php esc_attr_e( 'Decrease quantity', 'basel' ); ?>" />
	<?php endif; ?>
	...
	<?php if ( 'number' === $type ) : ?>
		<input type="button" value="+" class="plus" aria-label="<?php esc_attr_e( 'Increase quantity', 'basel' ); ?>" />
	<?php endif; ?>
