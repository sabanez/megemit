				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					?>
						...
						<?php if ( empty( $product_permalink ) ) : ?>
							...
							<?php
							if ( ! $_product->is_sold_individually() && $_product->is_purchasable() && basel_get_opt( 'mini_cart_quantity' ) && apply_filters( 'basel_show_widget_cart_item_quantity', true, $cart_item_key ) ) {
